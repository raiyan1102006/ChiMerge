...
The program takes the dataset and the max_interval as the input, and gives the split-points and final intervals. As the stopping condition, I've used max_interval = 6.
